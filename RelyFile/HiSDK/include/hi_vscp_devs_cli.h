...
#define HI_VSCP_CMD_RESTORE	   0x03
#define HI_VSCP_CMD_TELNET	   0x04
#define HI_VSCP_CMD_DEVNAME    0x05
...
SEARCH_API HI_S32 SEARCH_APICALL HI_VSCP_DEVSCLI_Register_IP( 
