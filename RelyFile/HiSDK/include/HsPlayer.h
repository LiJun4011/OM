...
#ifdef HI3511// 090708
#define PLAYER_MAX_WIDTH                (4096)
#define PLAYER_MAX_HEIGHT               (4096)
#else
#define PLAYER_MAX_WIDTH                (4096)
#define PLAYER_MAX_HEIGHT               (4096)
#endif
...
#define HI_NET_DEV_H264_STREAM_FLAG					0x53565848
#define HI_NET_DEV_H265_STREAM_FLAG					0x54565848
...
#define HI_STREAM_FILE		1
	...
	typedef struct hiPLAYER_YUV_INFO_S
	{
		PLAYER_FRAME_INFO_S YUVInfo;
		HI_S32 nDataLen;
		HI_U8 *pData;
	}PLAYER_YUV_INFO_S;
    ...
    HSPLAYER_API HRESULT HSPLAYER_APICALL HI_PLAYER_OpenFile(PLAYHANDLE hHandle,
            HI_U8 *pFileName);
	HSPLAYER_API HRESULT HSPLAYER_APICALL HI_PLAYER_OpenFileEx(PLAYHANDLE hHandle,
            HI_U8 *pFileName, HI_S32 s32Offset);
	...
	HSPLAYER_API HRESULT HI_PLAYER_SnapYUVData(PLAYHANDLE hHandle,PLAYER_YUV_INFO_S* pYUVInfo,
		HI_S32 nYUVType,HI_S32 *pNeedSize);
