...
#define HISDK_APICALL  __stdcall	/*用于Release静态库*/
#endif
#define HISDK_CALLBACK  __stdcall	/*用于Release静态库*/

	typedef LONG (HISDK_CALLBACK* OnUpdateCallBack)(
		HI_U32 u32Chn, 
		HI_S32 s32Persent,
		HI_VOID *pUserData);
	...
	typedef LONG (HISDK_CALLBACK* OnRealDataCallBack)(
	...
	typedef LONG (HISDK_CALLBACK* OnEventCallBack)(
		HI_U32 u32Chn, 
	...
	typedef LONG (HISDK_CALLBACK* OnMessageCallBack)(
		HI_U32 u32Chn,
		MD_TYPE_E eDataType,
		HI_U8*  pu8Buffer,
		HI_U32 u32Length,
		HI_VOID* pUserData);
	//移动侦测简单画框
	typedef LONG (HISDK_CALLBACK* OnDrawCallBack)(
		HI_U32 u32Chn, 
		RECT rcDrawRect,
		HI_CHAR* pszName, 
		HI_VOID* pUserData);
	...
	//叠加自绘,lRes HISDK内部用
	typedef HRESULT (HISDK_CALLBACK *HISDK_PostDrawCallBackEx)(HI_VOID * lRes,
			HI_VOID *hDc,
	...
	typedef LONG (HISDK_CALLBACK* OnVoiceDataCallBack)(
		HI_U32 u32Chn,
		HI_U8* pBuf, 
		HI_S32 s32Size,
		HI_U32 u32TimeStamp,
	...
	typedef HRESULT(HISDK_CALLBACK *OnDecCallBack)(
		HI_U32 u32Chn,
	...
	HISDK_API HI_HANDLE HISDK_APICALL HI_SDK_Login(const HI_CHAR* psHost, 
													const HI_CHAR* psUsername, const HI_CHAR* psPassword, 
													HI_U16 u16Port, 
													HI_S32 *ps32Err=0);
	...
	HISDK_API HI_S32 HISDK_APICALL HI_SDK_RealPlayEncExt(HI_HANDLE lHandle, HI_VOID *pWnd, HI_S_STREAM_INFO_EXT*  pstruStreamInfo);
	...
	HISDK_API HI_S32 HISDK_APICALL HI_SDK_SetPostDrawCallBackEx(HI_HANDLE lHandle,HI_U32 u32Chn,HISDK_PostDrawCallBackEx callback,HI_VOID *pUserData);
	...
	HISDK_API HI_S32 HISDK_APICALL HI_SDK_SnapYUVData(HI_HANDLE lHandle, HI_YUV_INFO_S* pYUVInfo,HI_S32 nYUVType,HI_S32 *pNeedSize);
	...
	//20170904 hiv200 对讲新cgi
	HISDK_API HI_S32 HISDK_APICALL HI_SDK_StartVoiceComEx(HI_HANDLE lHandle, HI_U32 u32Chn=0, OnVoiceDataCallBack callback=NULL, HI_VOID *pUserData=NULL);
	...
	HISDK_API HI_S32 HISDK_APICALL HI_SDK_SetPenPixel(HI_HANDLE lHandle, HI_S32 s32PenPixel);
	...
	HISDK_API HI_S32 HISDK_APICALL HI_SDK_EnhanceImage(HI_HANDLE lHandle, HI_U32 u32Acutance);
