...
// 获取Int型参数，如 Width和Height，详细内容参考SDK安装目录下的 CameraNode.xlsx 文件
...
// 设置Int型参数，如 Width和Height，详细内容参考SDK安装目录下的 CameraNode.xlsx 文件
...
// 获取Float型参数，如 ExposureTime和Gain，详细内容参考SDK安装目录下的 CameraNode.xlsx 文件
...
// 设置Float型参数，如 ExposureTime和Gain，详细内容参考SDK安装目录下的 CameraNode.xlsx 文件
...
// 获取Enum型参数，如 PixelFormat，详细内容参考SDK安装目录下的 CameraNode.xlsx 文件
...
// 设置Enum型参数，如 PixelFormat，详细内容参考SDK安装目录下的 CameraNode.xlsx 文件
...
// 获取Bool型参数，如 ReverseX，详细内容参考SDK安装目录下的 CameraNode.xlsx 文件
...
// 设置Bool型参数，如 ReverseX，详细内容参考SDK安装目录下的 CameraNode.xlsx 文件
...
// 获取String型参数，如 DeviceUserID，详细内容参考SDK安装目录下的 CameraNode.xlsx 文件UserSetSave
...
// 设置String型参数，如 DeviceUserID，详细内容参考SDK安装目录下的 CameraNode.xlsx 文件UserSetSave
...
// 执行一次Command型命令，如 UserSetSave，详细内容参考SDK安装目录下的 CameraNode.xlsx 文件
